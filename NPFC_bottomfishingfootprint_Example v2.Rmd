...
require(xlsx)
 ...
 library(grid)
 library(gridExtra)
source("C:/github/NPFC_BottomFishingFootprint/R/functions.R")
#rm(list=ls())
```
...
If you have any concerns or questions, please let me know. As Takeshige-san mentioned, it is important to note that these data are only to be used within the NPFC science committee and for SAI assessments.
Thank you,
Chris
