...
Here's a look at the relationship between resolution and number of cells excluded using the sample data.
...
resdata[k,3]<-sum(example_dd$not_enough_vessels)
k<-k+1
  }}

ggplot(resdata)+geom_line(aes(x=Spres,y=GDM,color=as.factor(Tres)))
